...
const R1=120000;
const R2=20000;
const maxport=4; // single mcp3424
...
MCP3424.prototype.readADC = function (port){
    var size
...
MCP3424.prototype.adc2volt = function (port){
...
MCP3424.prototype.setOpt = function (port,option,val){ //No error checking, just set the value...
...
MCP3424.prototype.setup = function (nrOfChannels) {
    ...
    for (port = 1; port <= nrOfChannels; port++) {
        ...
        */
        this.adc2volt(port); // to fill in rawVal and so on
